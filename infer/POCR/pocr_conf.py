...
infer_7 = {
    "crop_rect": {"left": 455, "right": 833, "top": 295, "bottom": 545},
    "warp_key_pts": {
        "top": np.array(
            [
                [190, 68],
...
infer_14 = {
    "crop_rect": {"left": 410, "right": 875, "top": 490, "bottom": 890},
    "target": [
        "경고",
        "81",
        "mm",
    ...
    "common_ocr_error": [
        ...
        ["m", ["n", "r"]],
        ["박격포", get_combs(["박", "바", "빅"], ["려", "경", "견", "겨", "격", "걱"], ["포"])],
        ["격포", get_combs(["경", "견", "겨", "격", "걱"], ["포"])],
        ["발사", get_combs(["밥", "반"], ["사"])],
        ["시에", ["기예"]],
        ...
        [
            "incre",
            get_combs(["i", "I", "("], ["n", "N"], ["c", "C"], ["r", "R"], ["e", "e"]),
        ],
        [
            "firing",
            get_combs(
                ["f", "F"], ["i", "I"], ["r", "R"], ["i", "I"], ["n", "N"], ["g", "G"]
            ),
        ],
        [
            "mortar",
            get_combs(
                ["m", "M"], ["o", "O"], ["r", "R"], ["t", "T"], ["a", "A"], ["r", "R"]
            ),
        ],
...
infer_12_13 = {"len": int(CONFIG["OCR"]["LEN"])}
