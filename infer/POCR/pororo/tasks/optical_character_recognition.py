...
from infer.POCR.pororo.tasks import download_or_load
from infer.POCR.pororo.tasks.utils.base import PororoFactoryBase, PororoSimpleBase
...
class PororoOcrFactory(PororoFactoryBase):
    ...
    def load(self, device: str):
        ...
        if self.config.n_model == "brainocr":
            from infer.POCR.pororo.models.brainOCR import brainocr
