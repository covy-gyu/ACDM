...
def print_status(bomb, cnt, prev_res_q, infer_time_q):
    ...
    print()
    print()
    print(' ' * COL1_LEFT_MARGIN + ' ' * int((COL1_H_BAR_LEN - len('Current Bomb')) / 2) + 'Current Bomb')
    ...
    col2_lines = [
        ...
        '─' * COL2_H_BAR_LEN,
        '  LOTS : {} (\033[92m{}\033[97m/\033[91m{}\033[97m)'
        .format(n_lot['total'], n_lot['normal'], n_lot['defect']),
        ' BOMBS : {} (\033[92m{}\033[97m/\033[91m{}\033[97m)'
        .format(n_bomb['total'], n_bomb['normal'], n_bomb['defect']),
        '─' * COL2_H_BAR_LEN,
        '',
    ...
    for i, prev_res in enumerate(prev_res_q):
        ...
        col2_lines.append('{:<15s}  {:2d} {} {:>5.1f}%'.format(lot_name, prev_res[0].num, test_res, ok_perc))
